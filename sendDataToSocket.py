...
if args.camera == 0:
    ...
    subprocess.Popen(["rpicam-still", "--datetime", "-t", "0", "--camera", "0", "-e", "png", "-o", "camera0data", "--timelapse", "1000", "--width", "4056", "--height", "3040", "--denoise", "off", "--shutter", "20"])
...
if args.camera == 1:
    ...
    port = 7777
    clear_folder(image_dir)
    subprocess.Popen(["rpicam-still", "--datetime", "-t", "0", "--camera", "1", "-e", "png", "-o", "camera1data", "--timelapse", "1000", "--width", "4056", "--height", "3040", "--denoise", "off",  "--shutter", "20"])
